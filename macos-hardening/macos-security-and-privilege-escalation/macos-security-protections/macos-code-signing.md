...
__attribute__ ((aligned(1)));
```
Note que hay diferentes versiones de esta estructura donde las antiguas pueden contener menos información.
...
Es posible acceder a esta información y crear o modificar requisitos con algunas API del `Security.framework` como:
