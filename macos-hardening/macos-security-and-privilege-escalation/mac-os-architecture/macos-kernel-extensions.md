...
कर्नेल एक्सटेंशन (Kexts) **पैकेज** हैं जिनका **`.kext`** एक्सटेंशन होता है जो **macOS कर्नेल स्पेस में सीधे लोड** किए जाते हैं, जो मुख्य ऑपरेटिंग सिस्टम को अतिरिक्त कार्यक्षमता प्रदान करते हैं।
...
4. अंततः **`kextd`** **कर्नेल को लोड** करने के लिए एक्सटेंशन को **बताने** में सक्षम होगा

यदि **`kextd`** उपलब्ध नहीं है, तो **`kextutil`** वही जांचें कर सकता है।
...
iOS में यह **`/System/Library/Caches/com.apple.kernelcaches/kernelcache`** में स्थित है, macOS में आप इसे **`find / -name "kernelcache" 2>/dev/null`** के साथ खोज सकते हैं। \
