...
```
这允许你**浏览不同的docker镜像的blob**并检查哪些文件被修改/添加。**红色**表示添加，**黄色**表示修改。使用**tab**键移动到其他视图，使用**space**键折叠/打开文件夹。

使用die，你将无法访问镜像不同阶段的内容。要做到这一点，你需要**解压每一层并访问它**。\
你可以通过在解压镜像的目录中执行以下命令来解压镜像的所有层：
```bash
tar -xf image.tar
...
* 查看[**订阅计划**](https://github.com/sponsors/carlospolop)!
* **加入** 💬 [**Discord 群组**](https://discord.gg/hRep4RUj7f)或[**电报群组**](https://t.me/peass)，或在 **Twitter** 🐦 上**关注**我们 [**@hacktricks\_live**](https://twitter.com/hacktricks\_live)**.**
