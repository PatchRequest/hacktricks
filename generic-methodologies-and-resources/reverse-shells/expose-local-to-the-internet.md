...
**Bu sayfanın amacı, diğer sunucuda (gerekirse sadece yerel olarak) hiçbir şey yüklemeye gerek kalmadan, EN AZINDAN yerel ham TCP portlarını ve yerel webleri (HTTP) internete açmaya olanak tanıyan alternatifler önermektir.**

## **Serveo**

[https://serveo.net/](https://serveo.net/) adresinden, **ücretsiz** olarak çeşitli http ve port yönlendirme özellikleri sunar.
```bash
...
[https://expose.dev/](https://expose.dev/) adresinden http ve tcp portlarını açmanıza olanak tanır:
```bash
# Expose web in 3000
