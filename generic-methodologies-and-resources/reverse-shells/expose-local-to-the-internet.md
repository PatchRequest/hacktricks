...
Von [https://serveo.net/](https://serveo.net/), es ermöglicht mehrere HTTP- und Port-Weiterleitungsfunktionen **kostenlos**.
```bash
...
Von [https://ngrok.com/](https://ngrok.com/) ermöglicht es, http- und tcp-Ports freizulegen:
```bash
# Expose web in 3000
ngrok http 8000
