...
З [https://telebit.cloud/](https://telebit.cloud/) він дозволяє відкрити http та tcp порти:
```bash
# Expose web in 3000
...
З [https://github.com/localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) це дозволяє безкоштовно експонувати http:
```bash
