...
Z [https://www.socketxp.com/download](https://www.socketxp.com/download) umożliwia eksponowanie tcp i http:
```bash
# Expose tcp port 22
...
Z [https://telebit.cloud/](https://telebit.cloud/) pozwala na wystawienie portów http i tcp:
```bash
# Expose web in 3000
...
Z [https://github.com/localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) pozwala na bezpłatne udostępnienie http:
```bash
